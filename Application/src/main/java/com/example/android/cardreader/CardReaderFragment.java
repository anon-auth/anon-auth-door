 ...
 */
public class CardReaderFragment extends Fragment implements AccessCardReader.AccessCallback {
    ...
    private void enableReaderMode() {
        ...
        if (nfc != null) {
            nfc.enableReaderMode(activity, mAccessCardReader, READER_FLAGS, null);
        }
    }
