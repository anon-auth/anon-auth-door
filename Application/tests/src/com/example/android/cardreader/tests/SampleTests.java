    ...
    */
    ...
    public void testBuildSelectApdu() {
        ...
        final byte[] expectedResult = {(byte) 0x00, (byte) 0xA4, 04, (byte) 0x00, (byte) 0x02,
                (byte) 0x12, (byte) 0x34};
        final byte[] result = AccessCardReader.BuildSelectApdu(aid);
    ...
    public void testHexToBinary() {
        ...
        final byte[] output = AccessCardReader.HexStringToByteArray("C0FFEE");
    ...
    public void testBinaryToHex() {
        ...
        final String output = AccessCardReader.ByteArrayToHexString(input);
